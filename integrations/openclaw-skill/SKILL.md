...
5. Continue only after operator review when the verdict is `REVISE` or `BLOCK`.

Krystal Quorum is a review gate. It is not an orchestrator and does not grant execution authority.
